...
module.exports = {
  ...
  chainWebpack(config) {
    ...
    // svg 默认是 file-loader 来处理的， 通过 vue inspect --rule svg 可以查看
    config.module
      .rule('svg')
    ...
    // set svgo-loader 主要是利用 svgo 优化 svg 大小
    // 参考：https://www.zhangxinxu.com/wordpress/2016/02/svg-compress-tool-svgo-experience/
    config.module
      .rule('svg-optimizer')
      .test(/\.svg$/)
      .include.add(resolve('src/icons'))
